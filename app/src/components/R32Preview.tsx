                    ...
                    {homeTeam ? (
                      <div className="flex flex-col items-center gap-2 min-h-[130px] justify-center">
                        {homeTeam.crest ? (
                          <img
                            src={homeTeam.crest}
                            alt={getTeamLabel(homeTeam)}
                            className="w-12 h-12 object-contain"
                          />
                        ) : (
                          <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
                            <span className="text-white/60 font-bold text-sm">
                              {getTeamLabel(homeTeam).substring(0, 3)}
                            </span>
                          </div>
                        )}
                        <div>
                          <div className="text-white font-bold text-xl">
                            {getTeamLabel(homeTeam)}
                          </div>
                    ...
                    {awayTeam ? (
                      <div className="flex flex-col items-center gap-2 min-h-[130px] justify-center">
                        {awayTeam.crest ? (
                          <img
                            src={awayTeam.crest}
                            alt={getTeamLabel(awayTeam)}
                            className="w-12 h-12 object-contain"
                          />
                        ) : (
                          <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
                            <span className="text-white/60 font-bold text-sm">
                              {getTeamLabel(awayTeam).substring(0, 3)}
                            </span>
                          </div>
                        )}
                        <div>
                          <div className="text-white font-bold text-xl">
                            {getTeamLabel(awayTeam)}
                          </div>
                          <div className="text-white/50 text-xs truncate max-w-[100px]">
                            {awayTeam.name || ""}
                          </div>
